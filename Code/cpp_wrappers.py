...
def fit2DGaussian_wrap(params0, im, a):
    ...
    fit2DGaussian = ctypes.WinDLL(r"K:\vanderVoortN\FRC\dev\Fit2DGaussian\x64\Release\Fit2DGaussian.dll").fit2DGaussian

    c_double_p = ctypes.POINTER(ctypes.c_double)
    imsize = im.flatten().shape[0]
